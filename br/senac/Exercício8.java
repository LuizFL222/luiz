...
public class Exercício8 {
    ...
    public static void main(String[] args) {
        ...
        int NumEleitores = NumVotosBrancos + NumVotosValidos + NumVotosNulos;
        JOptionPane.showMessageDialog(null, "A quantidade de eleitores: "
                + NumEleitores);
        ...
        JOptionPane.showMessageDialog(null, "O percentual de votos Brancos é: "
                + PercentualVotosBrancos + "%");
        JOptionPane.showMessageDialog(null, "O percentual de votos Nulos é: "
                + PercentualVotosNulos + "%");
        JOptionPane.showMessageDialog(null, "O percentual de votos Válidos é: "
